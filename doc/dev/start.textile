...
* curl -H "Content-Type: application/json" -H "Authorization: Bearer XXX" -X POST -d '{"description":"testHeute","userId":1,"date":"2011-11-19T18:28:52.607875Z"}' https://localhost:8443/user/me --insecure

h4. calendar update
* curl -H "Content-Type: application/json" -H "Authorization: Bearer XX" -X PUT -d '{"description":"testHeute","userId":1,"date":"2011-11-19T18:28:52.607875Z"}' https://localhost:8443/calendarentry/1 --insecure
** url ist falsch da das routing noch eine id erwartet

h4. task erstellen
* curl -H "Content-Type: application/json" -H "Authorization: Bearer xxx" -X POST -d '{"description":"testHeute", "belongingUsers":[1]}' https://localhost:8443/calendarentry/1 --insecure