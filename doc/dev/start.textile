...
h4. update User
* curl curl -H "Content-Type: application/json" -H "Authorization: Bearer xxx" -X PUT -d '{"loginName":"test", "userId":1}' https://localhost:8443/user/me --insecure
...
* curl -H "Authorization: Bearer XXX" -X POST -d '{"description":"testHeute","userId":1,"date":"2011-11-19T18:28:52.607875Z"}' https://localhost:8443/user/me --insecure
